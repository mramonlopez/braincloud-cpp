...
def buildWinStore(artifacts, version, rebuild):
	...
	projectPath = os.path.abspath("..")
	projectFile = projectPath + os.sep + "solutions" + os.sep + "windowsStore_vc120" + os.sep + "brainCloud.sln"

# winstore
	if rebuild:
		targets = "brainCloud_winstore:Rebuild;brainCloud_winstore:Publish"
	else:
		targets = "brainCloud_winstore:Publish"
...
# winphone 8.1
	if rebuild:
		targets = "brainCloud_wp:Rebuild;brainCloud_wp:Publish"
	else:
		targets = "brainCloud_wp:Publish"
...
# winphone 8.0
	if rebuild:
		targets = "brainCloud_wp8:Rebuild;brainCloud_wp8:Publish"
	else:
		targets = "brainCloud_wp8:Publish"
